    ...
    public static class LinqTasks
    {
        ...
        public static Emp Task9()
        {
            Emp result = Emps
                ...
                .OrderByDescending(em => em.HireDate)
                .FirstOrDefault();
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .GroupJoin(
                    ...
                    d => d.Deptno,
                    e => e.Deptno,
                    (d, empGroup) => new { Dept = d, EmpCount = empGroup.Count() }
                )
        ...
        public static IEnumerable<Dept> Task15()
        {
            IEnumerable<Dept> result = Depts
                .Join(
                    ...
                    d => d.Deptno,
                    e => e.Deptno,
                    (d, eCount) => new { Department = d, EmployeeCount = eCount.EmployeeCount }
                )
                .Where(de => de.EmployeeCount > 2)
                .OrderByDescending(de => de.EmployeeCount)
                .Select(de => de.Department)
                .ToList();

            // Print("Task 15", result);
        ...
        public static void Print<T>(string taskName, IEnumerable<T> collection)
        {
            Console.WriteLine("====" + taskName + "====");
            foreach (var dept in collection)
            {
        ...
        public static void Print<T>(string taskName, T result)
        {
            Console.WriteLine("====" + taskName + "====");
...
public static class CustomExtensionMethods
{
    ...
    {
        var result = emps.Where(e => emps.Any(e2 => e2.Mgr == e.Mgr && e2.Mgr != null))
            .OrderBy(e => e.Ename.Split(' ').Last())
